...
@ApiModel
public class MiniOmsCartSaveDTO extends BaseDTO {
    ...
    @ApiModelProperty(value = "商品规格ID(redis购物车中的hashKey-标识一个sku的商品)", example = "888", required = true)
