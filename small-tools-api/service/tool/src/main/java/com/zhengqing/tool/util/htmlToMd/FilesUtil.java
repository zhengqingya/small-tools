...
public class FilesUtil {
     ...
     * @param fileName
     *            文件名
     * @param fountainheadDirs
     *            源文件路径
     * @param armDirs
     *            目的文件路径
     * @return boolean
     */
    public boolean copyTheFile(String fileName, String fountainheadDirs, String armDirs) {
        ...
        try {
            ...
            if (oldFile.exists()) { // 文件存在时
                inStream = new FileInputStream(fountainheadDirs + "/" + fileName); // 读入原文件
     ...
     * @return boolean
     */
    public boolean cutTheFile(String fileName, String fountainheadDirs, String armDirs) {
        boolean isSucceed = false;
