...
public class WebOmsOrderAfterSaleServiceImpl extends OmsOrderAfterSaleServiceImpl<OmsOrderAfterSaleMapper, OmsOrderAfterSale> implements WebOmsOrderAfterSaleService {
    ...
    public String updateDataByWeb(WebOmsOrderAfterSaleUpdateDTO params) {
        ...
        ApiResult<SysPropertyVO> autoCloseAfterDayWrapper = this.ISysPropertyFeignApi.getByKey(
                SysPropertyKeyEnum.MALL_ORDER_SET_AFTER_SALE_BUYER_DELIVER_MILLISECOND.getKey());
        autoCloseAfterDayWrapper.checkForRpc();
        long autoCloseAfterMillisecond = Long.parseLong(autoCloseAfterDayWrapper.getData().getValue());
