...
public class MallCommonServiceImpl implements MallCommonService {
    ...
    public MallFileVO uploadFile(MultipartFile file) {
        ...
        return MallFileVO.builder()
                ...
                .url(this.qiniuFileUtil.uploadFile(file, originalFilename))
    ...
    public long getAutoReceiptMillisecond() {
        ApiResult<SysPropertyVO> autoReceiveWrapper = this.ISysPropertyFeignApi.getByKey(SysPropertyKeyEnum.MALL_ORDER_SET_AUTO_RECEIVE_MILLISECOND.getKey());
        autoReceiveWrapper.checkForRpc();
        return Long.parseLong(autoReceiveWrapper.getData().getValue());
    }
    ...
    private void initSpuData() {
        ...
        // 保存
        ApiResult<Boolean> dictDataWrapper = this.ISysDictFeignApi.addOrUpdateBatch(saveDictDataMap);
    ...
    private void initOrderSetData() {
        ...
        sysPropertyDataWrapper.checkForRpc();
