...
REM set APP_PORT_BASIC=20020
set APP_PORT_TOOL=20030
set APP_PORT_REMOTE=50001
REM set APP_NACOS_SERVER_ADDR=192.168.0.111:8848
set APP_NACOS_SERVER_ADDR=192.168.0.88:8848
...
echo "run"
docker run -d -e PROFILE=%APP_PROFILE% -p %APP_PORT_GATEWAY%:%APP_PORT_GATEWAY% -p %APP_PORT_SYSTEM%:%APP_PORT_SYSTEM% -p %APP_PORT_TOOL%:%APP_PORT_TOOL% --restart=always --name %APP_NAME% %APP_IMAGE%
REM pause
