package com.zhengqing.common.excel.util;
...
public class ExcelReportUtil {
    ...
    public <E, T> List<T> read(List<T> dataList, ExcelImportFileTypeEnum excelImportFileTypeEnum, MultipartFile file,
        ...
        try {
            Resource resource = new ClassPathResource(
                    this.DEFAULT_REPORT_IMPORT_FOLDER + excelImportFileTypeEnum.getMappingXml());
            // 上传文件流
    ...
    public File handleExport(List<Map<String, Object>> dataList, ExcelExportFileTypeEnum excelExportFileTypeEnum,
                             String exportPath) {
        Resource resource =
                new ClassPathResource(this.DEFAULT_REPORT_EXPORT_FOLDER + excelExportFileTypeEnum.getTemplateFile());
