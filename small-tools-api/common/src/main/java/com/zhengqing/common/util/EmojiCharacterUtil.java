 ...
 * <p> emoji表情符号处理工具类 </p>
 * 主要功能:
 * 1. 将带有emoji的字符串，格式化成unicode字符串
 * 2. 将可见unicode字符反解成emoji字符
 * 3. 过滤emoji字符
 *
 * <p>
 * 相关识知点：
...
//                System.err.println("codepoint:" + Integer.toHexString(codepoint));
    ...
    public static void main(String[] args) {
        ...
        System.out.println(EmojiCharacterUtil.escape("👴🐏🐎❀ 汉字 123"));
        System.out.println(EmojiCharacterUtil.reverse(EmojiCharacterUtil.escape("👴🐏🐎❀ 汉字 123")));
    }
