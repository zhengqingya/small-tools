<template>
  <my-base-wraper>
    ...
    <base-table-p
      ref="baseTable"
      api="st_other_anonymity.listPage"
      :params="listQuery"
    >
      ...
      <el-form ref="dataForm" :model="form" :rules="rules" label-width="100px">
        ...
        <div v-if="dialogStatus === 'detail'">
          <my-base-table-cell label-width="100px">
            ...
            <my-base-cell-item label="内容:">{{
              form.content
            }}</my-base-cell-item>
            <my-base-cell-item label="匿名用户名:">{{
              form.anonymousUserName
            }}</my-base-cell-item>
            <my-base-cell-item label="是否处理:">{{
              form.statusName
            }}</my-base-cell-item>
            ...
            <div v-if="form.status === 1">
              <my-base-cell-item label="匿名处理人:">{{
                form.anonymousHandlerName
              }}</my-base-cell-item>
              <my-base-cell-item label="备注:">{{
                form.remark
              }}</my-base-cell-item>
              <my-base-cell-item label="处理时间:">{{
                form.handleTime | dateTimeFilter
              }}</my-base-cell-item>
            </div>
          </my-base-table-cell>
        </div>
