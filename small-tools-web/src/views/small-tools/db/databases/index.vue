  ...
  <div class="app-container">
    <el-row :gutter="15" style="height: 100%">
      <el-col :span="6" style="height: 100%">
        <my-tree ref="myTree" :my-data-source-id="dataSourceId" @showTableList="showTableList"
          @showTableColumnList="showTableColumnList" />
      </el-col>
      <el-col :span="18" style="height: 100%">
        <base-wraper>
          <my-table v-if="showStatus === 'table'" ref="myTable" :data-source-id="dataSourceId" :db-name="dbName"
            @showTableColumnList="showTableColumnList" />
          <my-column v-else-if="showStatus === 'column'" ref="myColumn" :data-source-id="dataSourceId" :db-name="dbName"
