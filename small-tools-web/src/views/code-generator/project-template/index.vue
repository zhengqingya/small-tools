<template>
  <my-base-wraper>
    ...
    <base-table-p
      ref="baseTable"
      api="cg_project_template.listPage"
      :params="listQuery"
    >
      <el-table-column
        align="center"
      ...
      />
      <el-table-column align="center" width="250" :label="$t('table.actions')">
        <template slot-scope="scope">
    ...
    <!-- 模板数据源弹出框 -->
    <base-dialog
      :visible.sync="dialogVelocityContextVisible"
      :title="textMap[dialogStatus]"
      @close="handleDialogClose"
    >
      <base-table-p
        ref="projectVelocityContextTable"
        api="cg_project_template.listPageCodeProjectVelocityContext"
