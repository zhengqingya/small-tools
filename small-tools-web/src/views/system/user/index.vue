    ...
    <base-table-p ref="baseTable" api="sys_user.listPage" :params="listQuery">
      ...
      <el-table-column label="操作" align="center" width="230">
        <template v-slot="scope">
          ...
          <el-button link @click="resetPwd(scope.row.userId)">重置密码</el-button>
        </template>
      </el-table-column>
    </base-table-p>

    <base-dialog v-model="dialogVisible" :title="titleMap[dialogStatus]" width="30%" @close="handleDialogClose">
