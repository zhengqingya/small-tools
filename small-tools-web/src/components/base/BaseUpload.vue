<template>
  <div>
    ...
    <el-upload :action="uploadUrl" :show-file-list="false" :headers="dataToken" :before-upload="beforeUpload"
  ...
  data() {
    return {
      uploadUrl:
        ...
        '/system/web/api/file/uploadMultipartFile',
      dataToken: { Authorization: useStore().user.token },
      fileList: [],
    };
  },
  methods: {
